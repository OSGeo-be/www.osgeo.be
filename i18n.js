const TRANSLATIONS = {
  fr: {
    ...
    "foss4g26.reg.training.title": "Attestation de formation",
    "foss4g26.reg.training.desc":  "Vous avez besoin d'une attestation de formation pour votre participation ? C'est possible en parallèle, via un mécanisme de sponsoring organisationnel.",
  ...
  nl: {
    ...
    "foss4g26.reg.training.title": "Opleidingsattest",
    "foss4g26.reg.training.desc":  "Heeft u een opleidingsattest nodig voor uw deelname? Dat is mogelijk via een organisatorisch sponsormechanisme.",
  ...
  en: {
    ...
    "foss4g26.reg.training.title": "Training certificate",
    "foss4g26.reg.training.desc":  "Do you need a training certificate for your participation? This is possible in parallel, via an organisational sponsorship mechanism.",
    "foss4g26.reg.training.cta":   "Contact board@osgeo.be",
